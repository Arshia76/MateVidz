...
const Dashboard = () => {
  return (
    <Container className='p-4'>
      <Form
        style={{ direction: 'rtl' }}
        className=' w-100 d-flex justify-content-between  flex-column'
      >
        <img
          style={{
            margin: 'auto',
        ...
        >
          <Form.Label column sm={2} className='text-right text-sm-left'>
            نام کاربری
          </Form.Label>
          <Col sm={10}>
            <Form.Control type='text' placeholder='نام کاربری' />
          </Col>
        </Form.Group>
        <Form.Group
          className='mt-3 w-75 mx-auto'
        ...
        <Form.Group
          className='mt-3 w-75 mx-auto d-flex align-items-center'
          as={Row}
        ...
        <Form.Group className='mt-3 mx-auto w-25' as={Row}>
          <Col>
